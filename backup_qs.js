                ...
                <div style={{height: 'calc(100dvh - 50px)'}}>
                    {showLoading == false ?
                        <OSM 
                            ...
                            mapLocation={mapLocation} stopMarkers={stopMarkers} locationMain={locationMain}
                        ...
                        <Fade in={true} appear={true} >
                            <div id={`element-${index}`} key={index} 
                                ...
                                style={ index === selectedIndex ? 
                                    {height:'74px', width:'100%', display:'block', textAlign:'center', lineHeight:'60px'} :
                                    {height:'54px', width:'100%', display:'block', textAlign:'center', lineHeight:'40px'} 
                                } 
                            >
